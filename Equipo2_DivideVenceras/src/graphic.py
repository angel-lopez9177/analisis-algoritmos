...
class App:
    def __init__(self, root):
        ...
        self.colors = colors.Colores.tk_light()
        ...
        ttk.Label(inputs, text="Inicio:").grid(row=0, column=2, sticky="w", padx=(10, 0))
        self.entry_X_start = ttk.Entry(inputs, width=6, font=("Segoe UI", 10))
        self.entry_X_start.grid(row=0, column=3, padx=5, pady=4)
        
        ttk.Label(inputs, text="Fin:").grid(row=0, column=4, sticky="w", padx=(5, 0))
        ...
        ttk.Label(inputs, text="Inicio:").grid(row=1, column=2, sticky="w", padx=(10, 0))
        self.entry_Y_start = ttk.Entry(inputs, width=6, font=("Segoe UI", 10))
        self.entry_Y_start.grid(row=1, column=3, padx=5, pady=4)
        
        ttk.Label(inputs, text="Fin:").grid(row=1, column=4, sticky="w", padx=(5, 0))
